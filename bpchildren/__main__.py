"""
Blood Pressure Percentile Calculator MCP Server
Implementation using the mcp.server.fastmcp module
"""
import math
...
@mcp.tool()
def bp_percentile(years: int, months: int, height: int, sex: str, systolic: int, diastolic: int) -> dict:
    """
